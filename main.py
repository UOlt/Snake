...
class Menu(Canvas):
    ...
    def menu(self):
        ...
        level = IntVar()
        level.set(0)
        lvleasy_checkbutton = Radiobutton(text='Easy', value=1, variable=level, padx=15, pady=10)
        lvleasy_checkbutton.place(x=100, y=100)

        lvlmed_checkbutton = Radiobutton(text='Medium', value=2, variable=level, padx=15, pady=10)
        lvlmed_checkbutton.place(x=100, y=140)

        lvlhard_checkbutton = Radiobutton(text='Hard', value=3, variable=level, padx=15, pady=10)
        lvlhard_checkbutton.place(x=100, y=180)

        lvlhardr_checkbutton = Radiobutton(text='Harder', value=4, variable=level, padx=15, pady=10)
        lvlhardr_checkbutton.place(x=100, y=220)
        startButton = Button(self, text='Играть', command=self.startGame(level))
        startButton.place(x=100, y=260)
        self.pack()
        self.mainloop()
